...
Kp1GS = np.concatenate((np.linspace(kp_max1, kp_max1, int((len(t)/4))),np.linspace(kp_max1,kp_min1,int((len(t)/2))),np.linspace(kp_min1, kd_max1, int((len(t)/4)+1))))
Kp2GS = np.concatenate((np.linspace(kp_max1, kp_max1, int((len(t)/4))),np.linspace(kp_max1,kp_min1,int((len(t)/2))),np.linspace(kp_min1, kd_max1, int((len(t)/4)+1))))
Kd1GS = np.concatenate((np.linspace(kd_min1, kd_max1, int((len(t)/4))),np.linspace(kd_max1,kd_max1,int((len(t)/2))),np.linspace(kd_max1, kd_min1, int((len(t)/4)+1))))
Kd2GS = np.concatenate((np.linspace(kd_min2, kd_max2, int((len(t)/4))),np.linspace(kd_max2,kd_max2,int((len(t)/2))),np.linspace(kd_max2, kd_min2, int((len(t)/4)+1))))
Ki1GS = np.concatenate((np.linspace(ki1_min, ki1_max, int((len(t)/4))),np.linspace(ki1_max,ki1_min,int((len(t)/2))),np.linspace(ki1_min, ki1_max, int((len(t)/4)+1))))
Ki2GS = np.concatenate((np.linspace(ki1_min, ki1_max, int((len(t)/4))),np.linspace(ki1_max,ki1_min,int((len(t)/2))),np.linspace(ki1_min, ki1_max, int((len(t)/4)+1))))
...
for i in range(len(t)):
    ...
    if control_method == 'GS':
        ...
        tau1 = (Kp1GS[i]*error_theta1) + (Ki1GS[i]*error1_integral) + (Kd1GS[i]*errord_theta1)
        tau2 = (Kp2GS[i]*error_theta2) + (Ki2GS[i]*error2_integral) + (Kd2GS[i]*errord_theta2)
